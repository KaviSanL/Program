...
void loop()
{
  ...
  servo1_pos = map(flex1_pos, 990, 1000, 180, 0); 
  ...
  servo2_pos = map(flex2_pos, 840, 890, 180, 0); 
  ...
  servo3_pos = map(flex3_pos, 930, 890, 0, 180); 
